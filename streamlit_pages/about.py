...
def render_about():
    ...
    st.subheader("Step 1. Data Gathering & Prep")
    st.markdown(
        """
        We start by collecting historical data for individual stocks in the S&P 500 index. In addition, data for 11 ETFs is pulled to represent the different market sectors, Lastly, FRED economic data is pulled to aid in the trainning of our models. We pull data for a span of 20 years and organize it into a convenient CSV format. Additionally, we identify the last day of each month for further analysis.
        """
    )

    st.subheader("Step 2. Optimizer 1")
    st.markdown(
        """
    ...
    st.subheader("Step 3. Machine Learning Loop")
    st.markdown(
        """
    ...
    st.subheader("Step 4. Optimizer 2")
    st.markdown(
        """
    ...
    st.subheader("Step 5. Historical Date Loop")
    st.markdown(
        """
    ...
    st.subheader("Step 6. Historical Performance Table")
    st.markdown(
        """
